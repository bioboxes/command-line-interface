"""
Usage:
    biobox run profiling_benchmark <image> [--memory=MEM] [--cpu-shares=CPU] [--cpuset=CPU] [--no-rm] --prediction=FILE  --groundTruth=FILE --output=FILE [--task=TASK]

Options:
-h, --help                Show this screen.
-v, --version             Show version.
-p FILE, --prediction=FILE    Source profiling file
-g, --groundTruth=FILE    Source profiling file defining ground truth
        ...
        return [{
                "prediction":
                    {"type": "bioboxes.org:/profiling:0.9",
                     "value": opts['--prediction']
                     }
                },
                {
                "ground_truth": {
                        "value": opts['--groundTruth'],
                        "type": "bioboxes.org:/profiling:0.9"
                    }
                }
            ]
